...
2. If you are contributing a new OS, create a new directory following the guidelines above.
3. If you are creating a new template for an already supported OS, just create a HCL2 file and add auxiliary files it requires to the appropriate directories.
4. Run `packer validate .` in the directory to check your template.
5. Commit your changes and push the branch to your repository.
6. Open a Merge Request to packer-maas.
7. Wait for review.
